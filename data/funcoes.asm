...
EndDayScreen:
	...
	ForEndScreen1:
		...
		li a1,200		# define a dura��o da nota em ms
	...
	ecall						#função não recebe entrada
 	If_TMIntro:						#apenas toca a proxima nota de Notas
		...
		la t2,Intro_config
 		...
 		lw a3, 12(t2)
		IntroIf_TM1:
			bne t0,t1, IntroFim_If_TM1	# contador chegou no final? entÃƒÂ£o  vÃƒÂ¡ para SET_SONG para zerar o contador e as notas (loop infinito)
			sw zero, 4(t2)
			li t1, 0
		IntroFim_If_TM1:
		la t4, NotasIntro
